...
async def main():
    ...
    try:
        ...
        # and display some text and the code value when the messages arrive
        # We rename the file slightly when we copy it, although it isn't necessary
        await frame.upload_file("lua/code_frame_app.lua", "frame_app.lua")
